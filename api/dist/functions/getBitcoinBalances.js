...
function callNode(_x) {
  return _callNode.apply(this, arguments);
}
function _callNode() {
  _callNode = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(walletBatch) {
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        case 0:
          walletBatch.forEach( /*#__PURE__*/function () {
            var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(_ref2) {
              var address, walletType, confirmedTransactions, ownerId, assetIdInTraderDB, base_url, options;
              return _regeneratorRuntime().wrap(function _callee4$(_context4) {
                while (1) switch (_context4.prev = _context4.next) {
                  case 0:
                    address = _ref2.address, walletType = _ref2.walletType, confirmedTransactions = _ref2.confirmedTransactions, ownerId = _ref2.ownerId, assetIdInTraderDB = _ref2.assetIdInTraderDB;
                    base_url = "".concat(process.env.BITNODE, "/").concat(process.env.BITNODEK);
                    options = {
                      method: 'POST',
                      headers: {
                    ...
                    _context4.next = 5;
                    return (0, _nodeFetch["default"])(base_url, options).then(function (response) {
                      return response.json();
                    }).then( /*#__PURE__*/function () {
                      var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(responsedata) {
                        var result, totalReceived, txids, unconfirmedTxs, txs;
                        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
                          while (1) switch (_context3.prev = _context3.next) {
                            case 0:
                              result = responsedata.result;
                              totalReceived = result.totalReceived, txids = result.txids, unconfirmedTxs = result.unconfirmedTxs, txs = result.txs;
                              if (txids && assetIdInTraderDB) {
                                txids.forEach(function (txid) {
                                  (0, _nodeFetch["default"])(base_url, {
                                    method: 'POST',
                                    headers: {
                                      'Content-Type': 'application/json'
                                    },
                                    body: JSON.stringify({
                                      ...
                                      params: ["".concat(txid), 2]
                                    })
                                  }).then(function (response) {
                                    return response.json();
                                  }).then(function (txiddata) {
                                    ...
                                    if (confirmations > 16) {
                                      ...
                                      if (scriptPubKey.address === address) {
                                        if (!confirmedTransactions.includes(txid)) {
                                          ...
                                          var new_deposit = new _assetBalance["default"](deposit);
                                          new_deposit.save().then(function (newassetbalance) {
                                            (0, _updateWalletDeposit["default"])(newassetbalance).then(function () {
                                            ...
                                            })["catch"](function (walletdepositerr) {
                                              console.log(walletdepositerr);
                                            });
                                          });
...
var _default = getBitcoinBalances;
