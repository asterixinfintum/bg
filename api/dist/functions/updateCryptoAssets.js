...
var topThirty = ["BTC", "ETH", "XRP", "LTC", "BCH", "ADA", "XLM", "EOS", "BNB", "USDT", "XMR", "DASH", "NEO", "BSV", "TRX", "VET", "TEZ", "DOGE", "COSM", "POLY", "LINK", "UNI", "NEM", "ONT", "BAT", "USDC", "SNX", "MKR", "COMP", "ALGO"];
function updateCryptoAssets() {
  return _updateCryptoAssets.apply(this, arguments);
}
function _updateCryptoAssets() {
  _updateCryptoAssets = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var cryptoassets, cryptoassetsprices, cryptoassetstickers, _iterator, _step, _loop;
    return _regeneratorRuntime().wrap(function _callee$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.prev = 0;
          _context2.next = 3;
          return deleteAllSubjects(_cryptoAsset["default"]);
        case 3:
          _context2.next = 5;
          return deleteAllSubjects(_cryptoAssetTicker["default"]);
        case 5:
          _context2.next = 7;
          return deleteAllSubjects(_cryptoAssetPrice["default"]);
        case 7:
          _context2.next = 9;
        ...
        case 21:
          ...
          _loop = /*#__PURE__*/_regeneratorRuntime().mark(function _loop() {
            var cryptoassetObj, coin, cryptoassetsprice, cryptoassetsticker, prevdbCryptoAssset, previousPrice, priceChange, priceChanges, _cryptoassetsprice$0$, price, dailyChange, _cryptoassetsticker$, high, low, dbCryptoAssset;
            return _regeneratorRuntime().wrap(function _loop$(_context) {
              while (1) switch (_context.prev = _context.next) {
                case 0:
                  cryptoassetObj = _step.value;
                  coin = cryptoassetObj.data.coin;
                  ...
                  _context.next = 7;
                  return _cryptoAssetsDB["default"].findOne({
                    coin: coin
                  });
                case 7:
                  prevdbCryptoAssset = _context.sent;
                  previousPrice = prevdbCryptoAssset.price;
                  priceChange = {
                    pricechange: previousPrice,
                    updated: Date.now()
                  };
                  priceChanges = prevdbCryptoAssset.priceChanges;
                  priceChanges.push(priceChange);
                  _cryptoassetsprice$0$ = cryptoassetsprice[0].data, price = _cryptoassetsprice$0$.price, dailyChange = _cryptoassetsprice$0$.dailyChange;
                  _cryptoassetsticker$ = cryptoassetsticker[0].data, high = _cryptoassetsticker$.high, low = _cryptoassetsticker$.low;
                  _context.next = 16;
                  return _cryptoAssetsDB["default"].findOneAndUpdate({
                    coin: coin
                  }, {
                    $set: {
                      high: high,
        ...
        case 40:
          ...
          console.log(_context2.t2, 'there is an error here yo');
        case 43:
        case "end":
          return _context2.stop();
      }
    }, _callee, null, [[0, 40], [23, 32, 35, 38]]);
  }));
  return _updateCryptoAssets.apply(this, arguments);
}
function deleteAllSubjects(_x) {
  return _deleteAllSubjects.apply(this, arguments);
}
function _deleteAllSubjects() {
  _deleteAllSubjects = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(Subject) {
...
var _default = updateCryptoAssets;
