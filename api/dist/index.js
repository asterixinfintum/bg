...
var _cryptoassets = _interopRequireDefault(require("./routes/cryptoassets"));
var _admin = _interopRequireDefault(require("./routes/admin"));
var _edittracker = _interopRequireDefault(require("./routes/edittracker"));
...
var _fileretrieve = _interopRequireDefault(require("./routes/fileretrieve.js"));
...
var _runInventory = _interopRequireDefault(require("./functions/runInventory"));
...
var _getcryptotradedata = _interopRequireDefault(require("./trade/crypto/getcryptotradedata"));
var _getstockpairdata = _interopRequireDefault(require("./trade/stock/getstockpairdata"));
var _getcommoditiesdata = _interopRequireDefault(require("./trade/commodities/getcommoditiesdata"));
var _updatecryptoprices = _interopRequireDefault(require("./trade/crypto/updatecryptoprices"));
var _deposit = _interopRequireDefault(require("./wallet/functions/deposit"));
var _withdraw = _interopRequireDefault(require("./wallet/functions/withdraw"));
...
//getcommoditiesdata();
//updatecryptoprices();
function _callHomekeepers() {
  _callHomekeepers = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6() {
    return _regeneratorRuntime().wrap(function _callee6$(_context6) {
      while (1) switch (_context6.prev = _context6.next) {
        case 0:
          _context6.next = 2;
          return (0, _getcryptotradedata["default"])();
        case 2:
          setTimeout( /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5() {
            return _regeneratorRuntime().wrap(function _callee5$(_context5) {
              while (1) switch (_context5.prev = _context5.next) {
                case 0:
                  _context5.next = 2;
                  return (0, _getstockpairdata["default"])();
                case 2:
                  setTimeout( /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4() {
                    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
                      while (1) switch (_context4.prev = _context4.next) {
                        case 0:
                          _context4.next = 2;
                          return (0, _getcommoditiesdata["default"])();
                        case 2:
                          setTimeout( /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
                            return _regeneratorRuntime().wrap(function _callee3$(_context3) {
                              while (1) switch (_context3.prev = _context3.next) {
                                case 0:
                                  _context3.next = 2;
                                  return (0, _updatecryptoprices["default"])();
                                case 2:
                                  _context3.next = 4;
                                  return (0, _getBitcoinBalances["default"])();
                                case 4:
                                case "end":
...
app.use(_cryptoassets["default"]);
app.use(_admin["default"]);
app.use(_edittracker["default"]);
