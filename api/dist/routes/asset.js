...
var _asset2 = _interopRequireDefault(require("../models/asset"));
...
var asset = _express["default"].Router();
asset.get('/assets/', /*#__PURE__*/function () {
  ...
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res) {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.prev = 0;
          assetid = req.query.assetid; // Check if baseCurrency is provided
          if (assetid) {
            _context2.next = 4;
            break;
          }
        ...
        case 4:
          _context2.next = 6;
          return _asset2["default"].findOne({
            _id: assetid
          });
        case 6:
        ...
        case 12:
          ...
          console.error('Error retrieving assets:', _context2.t0);
          res.status(500).json({
            error: 'An error occurred while retrieving assets'
          });
        case 16:
