...
function executeorder(_x) {
  return _executeorder.apply(this, arguments);
}
function _executeorder() {
  _executeorder = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(_ref) {
    var percentage, currentWallet, assetToSell, assetToBuy, assetBuyUnitsToFill, assetBuyUnitsInUSD, assetSellUnitsToFill, filled, assetSellUnitsInUSD, fillPercent, fillingDetails, partialorderfilling;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 4:
          currentWallet = _context.sent;
          _context.next = 7;
          return _asset["default"].findOne({
            _id: this.assettosell
          });
        case 7:
          assetToSell = _context.sent;
          _context.next = 10;
          return _asset["default"].findOne({
            _id: this.assettobuy
          });
        case 10:
          assetToBuy = _context.sent;
        ...
        case 13:
          ...
          this.filled = filled;
          partialorderfilling = [fillingDetails].concat(_toConsumableArray(this.partialorderfilling));
        ...
        case 26:
          ...
          console.error('Error in executeBuy function:', _context.t0);
