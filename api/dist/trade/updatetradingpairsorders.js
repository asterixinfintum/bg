...
function updatetradingpairsorders(_x) {
  return _updatetradingpairsorders.apply(this, arguments);
}
function _updatetradingpairsorders() {
  _updatetradingpairsorders = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(pairid) {
    var pairitem, result;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 3:
          pairitem = _context3.sent;
          result = processPair(pairitem);
...
var processPair = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(pair) {
    var getRandomPrice, pairitem, getRandomValue, ordersresult, orders;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          getRandomPrice = function _getRandomPrice(basePrice, maxVariation) {
        ...
        case 3:
          ...
          return Promise.all(Array.from({
            ...
            var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(_, i) {
              ...
              return _regeneratorRuntime().wrap(function _callee$(_context) {
                while (1) switch (_context.prev = _context.next) {
                  ...
                  case 2:
                    ...
                    return _context.abrupt("return", dumborder);
                  case 9:
                  case "end":
        ...
        case 8:
          ...
          ordersresult = orders;
          return _context2.abrupt("return", ordersresult);
        case 11:
        case "end":
  ...
  return function processPair(_x2) {
    return _ref.apply(this, arguments);
  };
}();
var _default = updatetradingpairsorders;
