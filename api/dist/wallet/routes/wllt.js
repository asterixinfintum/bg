...
var walletroute = (0, _express["default"])();
...
walletroute.post('/withdraw', _authenticateToken["default"], /*#__PURE__*/function () {
  var _ref7 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6(req, res) {
    var _id, wallet, _req$body2, quantity, assetid;
    return _regeneratorRuntime().wrap(function _callee6$(_context6) {
      while (1) switch (_context6.prev = _context6.next) {
        ...
        case 4:
          ...
          _req$body2 = req.body, quantity = _req$body2.quantity, assetid = _req$body2.assetid;
          if (!wallet) {
            _context6.next = 12;
            break;
          }
          _context6.next = 9;
          return _wllt["default"].withdrawal(quantity, assetid, _id);
        case 9:
          res.status(200).send({
            message: 'done'
          });
...
walletroute.post('/deposit', _authenticateToken["default"], /*#__PURE__*/function () {
  var _ref9 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee8(req, res) {
    var _id, assetid, quantity, wallet;
...
walletroute.post('/swap', _authenticateToken["default"], /*#__PURE__*/function () {
  var _ref10 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee9(req, res) {
    var _id, wallet, fee, _req$body3, quantity, assetFrom, assetTo, swap;
    return _regeneratorRuntime().wrap(function _callee9$(_context9) {
      while (1) switch (_context9.prev = _context9.next) {
        ...
        case 4:
          ...
          fee = 0;
          _req$body3 = req.body, quantity = _req$body3.quantity, assetFrom = _req$body3.assetFrom, assetTo = _req$body3.assetTo;
          if (!wallet) {
            _context9.next = 14;
            break;
          }
          _context9.next = 10;
          return wallet.swap(quantity, fee, assetFrom, assetTo);
        case 10:
          swap = _context9.sent;
          res.status(200).send({
            swap: swap
...
walletroute.get('/wllts', /*#__PURE__*/function () {
