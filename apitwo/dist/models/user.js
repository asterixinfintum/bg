...
var TailoredDashboardSchema = new Schema({
...
TailoredDashboardSchema.path('profitstatetext').get(function () {
  if (this.profitsstate === 'profit') {
    return "Increased ".concat(this.myprofitpercentfromyesterday, "% from yesterday");
  } else if (this.profitsstate === 'loss') {
    return "decreased ".concat(this.myprofitpercentfromyesterday, "% from yesterday");
  } else {
