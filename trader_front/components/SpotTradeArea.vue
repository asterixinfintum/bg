<template>
    <div class="spottradearea">
        ...
        <div class="spottradearea__wallettype spottradearea__nav no-padding" v-if="walletType === 'fiat/spot'">
            <div class="spottradearea__wallettype spottradearea__nav current">
                <h2>{{ walletTradingFrom }}</h2>
            </div>

            <div class="spottradearea__wallettype spottradearea__nav notcurrent" @click="toggleWallet('margin')">
                <h2>Margin Trading</h2>
            </div>

            <div class="spottradearea__autotradetoggle">
                <label class="spottradearea__autotradetoggle--label">
                    Auto Trader
                </label>
                <div class="toggle-switch off" :class="{
                    on: autoTrade === 'true'
        ...
        <div class="spottradearea__wallettype spottradearea__nav no-padding" v-if="walletType === 'margin'">
            <div class="spottradearea__wallettype spottradearea__nav notcurrent" @click="toggleWallet('spot')">
                <h2>Spot</h2>
            </div>

            <div :class="{

            }" class="spottradearea__wallettype spottradearea__nav current">
        ...
        <div class="spottradearea__nav" v-if="walletType === 'margin'">
            <span class="spottradearea__nav--btn" :class="{
                current: margin === 'standard'
            }" @click="toggleMargin('standard')">Standard</span>
            <span class="spottradearea__nav--btn" :class="{
                current: margin === '2X'
            }" @click="toggleMargin('2X')">2X</span>
            <span class="spottradearea__nav--btn" :class="{
                current: margin === '3X'
            }" @click="toggleMargin('3X')">3X</span>
            <span class="spottradearea__nav--btn" :class="{
                current: margin === '4X'
            }" @click="toggleMargin('4X')">4X</span>
            <span class="spottradearea__nav--btn" :class="{
                current: margin === '5X'
        ...
        <div class="spottradearea__tradetypes">
            ...
            }" @click="toggleOrderType('limit')">Limit</span>
            <span class="spottradearea__tradetypes--btn" :class="{
                current: orderType === 'stop limit'
            }" @click="toggleOrderType('stop limit')">Stop Limit</span>
        </div>
        ...
        <div class="spottradearea__fundaccount" v-if="fundaccount_popup">
            ...
            <div class="spottradearea__fundbody">
                <div class="spottradearea__head">
                    ...
                    <h3 class="spottradearea__head--h3">Select your preferred method to fund your account.</h3>
                ...
                <div class="spottradearea__fundoption">
                    <div class="spottradearea__fundoption--left">
                        ...
                        <span class="spottradearea__fundoption--description">Transfer from your internal wallet</span>
                    </div>
                    <div class="spottradearea__fundoption--right">
                        <button class="spottradearea__fundoption--btn btn colored-btn">Transfer</button>
                    </div>
                </div>
                ...
                <div class="spottradearea__fundoption">
                    <div class="spottradearea__fundoption--left">
                        ...
                        <span class="spottradearea__fundoption--description">Convert from asset in wallet</span>
                    </div>
                    <div class="spottradearea__fundoption--right">
                        <button class="spottradearea__fundoption--btn btn colored-btn">Convert</button>
                    </div>
                </div>
