        ...
        <div class="popup">
            <div class="popup__body transactionstyle__body">
                ...
                <div class="transactionstyle__selectassetcat">
                    ...
                    <div class="transactionstyle__selectassetcat--area" @click="setAssetCategory('crypto')">
                        <figure>
                    ...
                    <div class="transactionstyle__selectassetcat--area" @click="setAssetCategory('fiat')">
                        <figure>
                    ...
                    <div class="transactionstyle__selectassetcat--area" @click="setAssetCategory('stock')">
                        <figure>
                ...
                <div class="transactionstyle__listitemsassets">
                    ...
                    <div class="transactionstyle__listitemsasset" 
                        ...
                        <figure class="transactionstyle__listitemsasset--logo">
                            <img src="https://rawcdn.githack.com/trustwallet/assets/master/blockchains/ethereum/assets/0xae7ab96520DE3A18E5e111B5EaAb095312D7fE84/logo.png"/>
                            <figure>
                        ...
                        <div class="transactionstyle__listitemsasset--labels">
                            ...
                            <label class="chain" v-if="cryptoasset.networkList[0]">{{ cryptoasset.coin }}</label>
                        </div>
                    </div>
