                ...
                <div class="landing__jumbotron">
                    ...
                    <div class="landing__jumbotrontop">
                        ...
                        <div class="landing__jumbotrontop--sub">
                            <p>Exceptional platforms, competitive spreads, minimal fees, and unwavering assistance.</p>
                            <p>Discover why over a million traders globally trust us as their preferred</p>
                            <p>trading partner.</p>
                        </div>
...
.landing {
    ...
    &__perksarea {
        ...
        & button {
            box-shadow: 1px 1px 8px rgba($landing-primary, .3)
        }
    }

    &__perk {
        border-radius: $box-radius;
        background: rgba($defipopup-body, .6);
    ...
    &__inthenewscard {
        border-radius: $box-radius;
        background: rgba($defipopup-body, .4);
        padding: #{scaleValue(31)};
