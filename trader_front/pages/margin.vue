                        ...
                        <div class="layout-stretch">
                            ...
                            <div class="margin__main layout-padding">
                                <div class="balancearea row">
                                    ...
                                    <div class="balancearea__section secondary">
                                        <div class="balancearea__secondarybalance">
                                            <h3 class="balancearea__secondarybalance--h3">Total Debt</h3>
                                    ...
                                    <div class="balancearea__section secondary">
                                        <div class="balancearea__secondarybalance">
                                            <h3 class="balancearea__secondarybalance--h3">Account Equity:</h3>
                                            <div class="balancearea__secondarybalance--btcvalue">0.00000000 BTC</div>
                                            <div class="balancearea__secondarybalance--usdvalue">≈ $0.00000000</div>
                                        </div>
                                    </div>
                                ...
                                <div class="balancearea row">
                                    <div class="balancearea__section secondary">
                                        <div class="balancearea__secondarybalance">
                                            <h3 class="balancearea__secondarybalance--h3">PNL</h3>
                                            <div class="balancearea__secondarybalance--btcvalue">0.00000000 USDT</div>
