    ...
    <div class="header" :class="generalLandingPageStyle" id="header">
                        ...
                        <div class="header__dropdowncontent">
                            <div class="header__dropdowncontent--item">
                                <figure class="header__dropdowncontent--logo">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="" class="css-1s4hjvp"><use xlink:href="#market-overview-g"></use></svg>
                                </figure>
                                <div>
                                    <span class="header__dropdowncontent--headerlabel">Cryptocurrencies</span>
                                    <span class="header__dropdowncontent--textlabel">
                                        Unlock the future of finance with our cutting-edge Cryptocurrencies.
                                        Embrace the power of decentralized digital assets with our innovative Cryptocurrencies
                                    </span>
                                </div>
                            </div>
        ...
        <div class="header__right">
            ...
            <div class="header__btns header__menu" v-if="!client">
                <div class="header__menuitem">
                    <button class="btn transparent landing rounded-corner header-padding" @click="navigateToPage('login')" id="login-btn">Log In</button>
                </div>
                <div class="header__menuitem">
                    <button class="btn padded-btn colored-btn colored landing rounded-corner header-padding" @click="navigateToPage('register')">open an account</button>
                </div>
            </div>
...
export default {
  name: 'Landing',
  mixins: [generalutilities, clientMixin, cryptoassetsMixin],
  methods: {
