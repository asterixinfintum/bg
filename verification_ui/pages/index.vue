      ...
      <div class="content">
        ...
        <div class="verification__popup" v-if="currentStep === 'step 1'">
          <div class="verification__popup--body">
            <span class="verification__popup--close" @click="closepopup">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" class="css-3kwgah"><path d="M6.697 4.575L4.575 6.697 9.88 12l-5.304 5.303 2.122 2.122L12 14.12l5.303 5.304 2.122-2.122L14.12 12l5.304-5.303-2.122-2.122L12 9.88 6.697 4.575z" fill="currentColor"></path></svg>
            </span>
            ...
            <div class="verification__upload">
              ...
              <button v-if="verification_file"
                      @click="callFileUpload" 
                      class="verification__upload--btn btn padded-btn colored-btn">Next</button>
            </div>
          </div>
        </div>
        ...
        <div class="verification__popup" v-if="currentStep === 'step 2'">
          <div class="verification__popup--body">
            ...
            <div class="verification__popup--permissionproceed">
              ...
              <span>
                <button @click="setStep(2)" class="verification__upload--btn btn padded-btn colored-btn">
                  Proceed 
        ...
        <div class="verification__popup" v-if="currentStep === 'step 3'">
          <div class="verification__popup--body">
            ...
            <h3 class="verification__popup--h3">Make sure your face is centered in the circle and the environment is well lit</h3>
          ...
          <div class="verification__popup--body">
            ...
            <div class="verification__popup--permissionproceed">
              ...
              <span v-if="!videoRecorderShown">
                <button @click="showvideoRecorder" class="verification__upload--btn btn padded-btn colored-btn">
                  Understood proceed 
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" class="first"><path fill-rule="evenodd" clip-rule="evenodd" d="M12.288 12l-3.89 3.89 1.768 1.767L15.823 12l-1.768-1.768-3.889-3.889-1.768 1.768 3.89 3.89z" fill="currentColor"></path></svg>
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" class="second"><path fill-rule="evenodd" clip-rule="evenodd" d="M12.288 12l-3.89 3.89 1.768 1.767L15.823 12l-1.768-1.768-3.889-3.889-1.768 1.768 3.89 3.89z" fill="currentColor"></path></svg>
                </button>
        ...
        <div class="verification__popup" v-if="currentStep === 'step 5'" @click="closepopup">
          <div class="verification__popup--body">
            ...
            <div class="verification__popup--permissionproceed">
              ...
              <span class="thankyou">Thank you for providing the necessary information for your Know Your Customer (KYC) verification. We appreciate your cooperation and understanding as we ensure the safety and security of our services. Our team will now review the provided information to complete the verification process.</span>
              <span class="thankyou">Please note that the verification process may take some time, and we will notify you promptly once it is completed. If any additional information is required, we will reach out to you using the contact details you provided.</span>
              <span class="thankyou">We value your privacy and assure you that all the information you have shared will be treated with the utmost confidentiality and in compliance with relevant data protection laws.</span>
                ...
                <div class="verification__user">
                  <div class="verification__userdetails">
                    ...
                    <div class="verification__userdetail">
                      ...
                      <div class="verification__userdetail--verified" v-if="client.verified">
                        <span>
                          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" class="css-ujzvcj"><path fill-rule="evenodd" clip-rule="evenodd" d="M7.035 16.812l-.001.002 2.121 2.121.002-.002 2.121-2.12 9.19-9.192-2.12-2.121-9.191 9.19-3.536-3.534-2.121 2.12 3.535 3.536z" fill="currentColor"></path></svg>
                        </span>
                        <span class="text">
                          Verified
                        </span>
                  ...
                  <div class="verification__reminder">
                    <div class="verification__reminder--warningsvg">
                      <span class="verification__reminder--warningsvg--svg">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 96 96" fill="none" class="css-1ugebgo"><path fill-rule="#204db0" clip-rule="evenodd" d="M88 48c0 22.091-17.909 40-40 40S8 70.091 8 48 25.909 8 48 8s40 17.909 40 40z" fill="#204db0"></path><path d="M48 19c16.016 0 29 12.984 29 29S64.016 77 48 77 19 64.016 19 48s12.984-29 29-29z" fill="#204db0"></path><path d="M45 66h6v-6h-6v6zM51 54V30h-6v24h6z" fill="#14151A"></path><defs><linearGradient id="general-warning_svg__paint0_linear_22059_28207" x1="8" y1="48" x2="102.5" y2="48" gradientUnits="userSpaceOnUse"><stop stop-color="#F0B90B" stop-opacity="0"></stop><stop offset="1" stop-color="#F0B90B"></stop></linearGradient><linearGradient id="general-warning_svg__paint1_linear_22059_28207" x1="77" y1="48" x2="19" y2="48" gradientUnits="userSpaceOnUse"><stop stop-color="#F0B90B"></stop><stop offset="1" stop-color="#F8D33A"></stop></linearGradient></defs></svg>
                      </span>
                    </div>
                    ...
                    <div class="verification__reminder--text">
                      <p>Please upload a new ID document before it expires, or your Binance account will be restricted to “Withdrawal Only” 30 days after the expiration date.</p>
                    </div>

                    <div class="verification__reminder--action">
                      <button class="verification__reminder--action--btn btn colored-btn padded-btn" @click="openpopup(`passport`)">Get Verified with passport</button>
                      <button class="verification__reminder--action--btn btn colored-btn padded-btn" @click="openpopup(`driver's licence`)">Get Verified with driver's licence</button>
                    </div>
                  </div>

                  <div class="verification__reminder blur">
                    <h3 class="verification__reminder--h3">Upgrade to increase your limits to 2M USD Daily.</h3>
                    ...
                    <div class="verification__reminder--action">
                      <button class="verification__reminder--action--btn btn padded-btn greyed-btn" @click="popupAction(action)">Get Verified Plus</button>
                    </div>
                  </div>
                </div>
...
export default {
  ...
  computed: {
    ...mapState({
      ...
      uploaded_verification_file_details: state => state.verification.uploaded_verification_file_details,
    })
  },
  watch: {
